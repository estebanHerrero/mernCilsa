            ...
            <div className="p-10 rounded-lg shadow-md w-96 border border-[#313131] flex flex-col">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        placeholder="Ingrese su nombre" onChange={(e) => setValues({...values, nombre: e.target.value})} />
                    </div>
                    <div className="mb-4">
                        ...
                        placeholder="Ingrese su apellido" onChange={(e) => setValues({...values, apellido: e.target.value })}/>
                    </div>
                    <div className="mb-4">
                        ...
                        placeholder="Ingrese su correo electrónico" onChange={(e) => setValues({...values, correoElectronico: e.target.value })}/>
                    </div>
                    <div className="mb-6">
                        ...
                        placeholder="Ingrese su contraseña" onChange={(e) => setValues({...values, contrasenia: e.target.value })}/>
                    </div>
